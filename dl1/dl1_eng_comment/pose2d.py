...
class Pose2D:
    ...
    # The relative position of the current coordinate system npose as viewed from the standard coordinate system BPOSE (Inverse Compounding Operator)
    ...
    # Including coordinate npose, which has advanced only relative position Relpose from the reference coordinates BPOSE (Compounding Operator)
    @staticmethod
