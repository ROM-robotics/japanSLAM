...
class CovarianceCalculator:
    ...
    def calMotionCovarianceSimple(self, motion, dT, cov):
        ...
        wthre = 0.01  # wtの下限値 0.05(Raspberry Pi Mouse), 0.01(TurtleBot3)
        ...
        C1 = np.eye(3)
        C1[0, 0] = 1. * dx * dx  # 並進成分x 3.0(Raspberry Pi Mouse), 1.0(TurtleBot3)
        C1[1, 1] = 1. * dy * dy  # 並進成分y 3.0(Raspberry Pi Mouse), 1.0(TurtleBot3)
        C1[2, 2] = 25. * da * da  # 回転成分 オドメトリの回転成分ずれが大きい場合 300.0(Raspberry Pi Mouse), 25.0(TurtleBot3)  
